...
namespace StoreWebApp.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(project0Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderId,CustomerId,StoreId,OrderTotalPrice,Date")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,CustomerId,StoreId,OrderTotalPrice,Date")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
